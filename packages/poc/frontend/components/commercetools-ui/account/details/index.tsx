...
import { AddressesSection, GeneralSection, SecuritySection, OrdersHistorySection, Vaulting } from './sections/exporter';
...
const AccountDetails: React.FC<AccountDetailsProps> = () => {
  ...
  const tabs = [
    ...
    { name: formatAccountMessage({ id: 'vaulting', defaultMessage: 'Pure Vaulting' }), href: '#vaulting' },
  ];
