...
const INPUT_STYLES =
  'block w-full rounded-sm border-gray-300 py-3 px-4 shadow-sm focus:border-accent-400 focus:ring-accent-400';
const LABEL_STYLES = 'block text-sm font-medium text-gray-700 dark:text-light-100';
                  ...
                  <div className="relative mx-auto max-w-xl">
                    ...
                    <div className="mt-12">
                      <form onSubmit={handleSubmit} className="grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-8">
                        <div>
                          <label htmlFor="first-name" className={LABEL_STYLES}>
                        ...
                        <div>
                          <label htmlFor="last-name" className={LABEL_STYLES}>
                        ...
                        <div className="">
                          <label htmlFor="street-number" className={LABEL_STYLES}>
                        ...
                        <div className="">
                          <label htmlFor="street-name" className={LABEL_STYLES}>
                        ...
                        <div>
                          <label htmlFor="postal-code" className={LABEL_STYLES}>
